      ...
      <section className={styles.hero}>
        <div className={styles.heroGrid}>
          <div>
            ...
            <a href="#start" className={styles.button} style={{ marginTop: "24px" }}>
              Get started
            </a>
          </div>

          <div className={styles.card} id="start">
            <h2 className={styles.cardHeading}>Install Sendly</h2>
            <p className={styles.cardText}>
              Add Sendly from the Shopify App Store, then open it from your store
              admin under Apps.
            </p>
            <ul className={styles.trust}>
              <li>7-day free trial</li>
